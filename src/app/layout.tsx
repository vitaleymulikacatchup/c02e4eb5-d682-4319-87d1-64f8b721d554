...
export const metadata: Metadata = {
  title: "David Martinez - Professional Guitarist & Music Creator",
  description: "Professional guitarist offering live performances, studio recording, and guitar lessons. 15+ years experience creating memorable musical moments for events, recordings, and students.",
  keywords: "guitarist, live music, guitar lessons, studio recording, wedding music, acoustic guitar, music teacher, professional musician",
  metadataBase: new URL("https://davidmartinezguitar.com"),
  alternates: {
    canonical: "https://davidmartinezguitar.com"
  },
  openGraph: {
    title: "David Martinez - Professional Guitarist",
    description: "Professional guitarist for live performances, recording sessions, and guitar instruction",
    siteName: "David Martinez Guitar",
    images: [
      {
        url: "https://images.pexels.com/photos/9419224/pexels-photo-9419224.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Professional guitarist David Martinez performing"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "David Martinez - Professional Guitarist",
    description: "Professional guitarist for live performances, recording sessions, and guitar instruction",
    images: ["https://images.pexels.com/photos/9419224/pexels-photo-9419224.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
